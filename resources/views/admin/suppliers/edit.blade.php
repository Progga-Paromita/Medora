                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                               id="name" value="{{ old('name', $getRecord->name) }}" placeholder="Enter supplier name" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" 
                                                   id="phone" value="{{ old('phone', $getRecord->phone) }}" placeholder="Enter phone number" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                                   id="email" value="{{ old('email', $getRecord->email) }}" placeholder="Enter email address">
                                ...
                                <div class="mb-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" 
                                                  rows="3" placeholder="Enter full address" required>{{ old('address', $getRecord->address) }}</textarea>
                                    </div>
                                </div>
