                        ...
                        <div class="card-body p-4">
                            <form action="{{ url('admin/invoices/create') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="invoice_number" class="form-control" id="invoice_number" value="{{ old('invoice_number', 'INV-' . strtoupper(Str::random(6))) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="invoice_date" class="form-control" id="invoice_date" value="{{ old('invoice_date', date('Y-m-d')) }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" min="0" name="total_amount" id="total_amount" class="form-control" value="{{ old('total_amount') }}" placeholder="0.00" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" min="0" name="total_discount" id="total_discount" class="form-control" value="{{ old('total_discount', 0) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.1" min="0" name="tax" id="tax" class="form-control" value="{{ old('tax', 0) }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top" style="border-color: var(--bs-border-color) !important;">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i> Generate Invoice</button>
                                </div>
                            </form>
                        </div>
                    </div>
