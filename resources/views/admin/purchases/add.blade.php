                            ...
                            <form action="{{ url('admin/purchases/add') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="invoice_id" id="invoice_id" class="form-select" required>
                                            ...
                                            @foreach($getInvoiceNo as $invoice)
                                                <option value="{{ $invoice->id }}" data-total="{{ $invoice->net_total }}">
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="0" name="net_total" id="net_total" class="form-control" value="{{ old('net_total') }}" placeholder="Enter total amount" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="voucher_number" id="voucher_number" class="form-control" value="{{ old('voucher_number') }}" placeholder="Enter voucher number">
                                    </div>
                                </div>
