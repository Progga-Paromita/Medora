                            ...
                            <tbody>
                                @forelse($customers as $value)
                                    <tr>
                                        ...
                                        <td class="fw-bold text-warning">{{ $value->doctor_name ?? 'N/A' }}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3">
                                                    @if($value->is_deleted == 0)
                                                        <li>
                                                            <a href="{{ url('admin/customers/show/'.$value->id) }}" class="dropdown-item py-2">
                                                                <i class="bi bi-eye text-info me-2"></i> View Profile
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ url('admin/customers/edit/'.$value->id) }}" class="dropdown-item py-2">
                                                                <i class="bi bi-pencil text-primary me-2"></i> Edit Profile
                                                            </a>
                                                        </li>
                                                        <li><hr class="dropdown-divider"></li>
                                                        <li>
                                                            <a href="{{ url('admin/customers/delete/'.$value->id) }}" class="dropdown-item py-2 text-danger"
                                                    ...
                                                    @else
                                                        <li>
                                                            <a href="{{ url('admin/customers/restore/'.$value->id) }}" class="dropdown-item py-2 text-success"
                                                               onclick="return confirm('Are you sure you want to restore this soft-deleted customer?');">
                                                                <i class="bi bi-arrow-counterclockwise me-2"></i> Restore Customer
                                                            </a>
                                                        </li>
                                                    @endif
                                                </ul>
