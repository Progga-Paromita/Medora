                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name" value="{{ old('name') }}" placeholder="e.g. Paracetamol" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sku" class="form-control" id="sku" value="{{ old('sku') }}" placeholder="e.g. SKU-100293">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="generic_name" class="form-control" id="generic_name" value="{{ old('generic_name') }}" placeholder="e.g. Acetaminophen">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="strength" class="form-control" id="strength" value="{{ old('strength') }}" placeholder="e.g. 500mg, 10ml, 5%">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="packaging" class="form-control" id="packaging" value="{{ old('packaging') }}" placeholder="e.g. Strip of 10, Box of 100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="temperature_control" id="temperature_control" class="form-select">
                                                <option value="Room Temp">Standard Room Temp (15-25°C)</option>
                                                <option value="Refrigerated">Refrigerated (2-8°C)</option>
                                                <option value="Frozen">Frozen (Below -15°C)</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="prescription_required" id="prescription_required" class="form-select">
                                                ...
                                                <option value="1">Yes (Requires Doctor Prescription)</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
