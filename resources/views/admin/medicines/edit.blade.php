                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                                   id="name" value="{{ old('name', $getRecord->name) }}" placeholder="e.g. Paracetamol" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="generic_name" class="form-control @error('generic_name') is-invalid @enderror" 
                                                   id="generic_name" value="{{ old('generic_name', $getRecord->generic_name) }}" placeholder="e.g. Acetaminophen" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sku" class="form-control @error('sku') is-invalid @enderror" 
                                                   id="sku" value="{{ old('sku', $getRecord->sku) }}" placeholder="e.g. SKU-100293">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="strength" class="form-control @error('strength') is-invalid @enderror" 
                                                   id="strength" value="{{ old('strength', $getRecord->strength) }}" placeholder="e.g. 500mg, 10ml, 5%">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="packaging" id="packaging" class="form-select @error('packaging') is-invalid @enderror" required>
                                                ...
                                                <option value="Tablet" {{ old('packaging', $getRecord->packaging) == 'Tablet' ? 'selected' : '' }}>Tablet</option>
                                                <option value="Capsule" {{ old('packaging', $getRecord->packaging) == 'Capsule' ? 'selected' : '' }}>Capsule</option>
                                                <option value="Syrup" {{ old('packaging', $getRecord->packaging) == 'Syrup' ? 'selected' : '' }}>Syrup</option>
                                                <option value="Injection" {{ old('packaging', $getRecord->packaging) == 'Injection' ? 'selected' : '' }}>Injection</option>
                                                <option value="Ointment" {{ old('packaging', $getRecord->packaging) == 'Ointment' ? 'selected' : '' }}>Ointment</option>
                                                <option value="Cream" {{ old('packaging', $getRecord->packaging) == 'Cream' ? 'selected' : '' }}>Cream</option>
                                                <option value="Drops" {{ old('packaging', $getRecord->packaging) == 'Drops' ? 'selected' : '' }}>Drops</option>
                                                <option value="Suspension" {{ old('packaging', $getRecord->packaging) == 'Suspension' ? 'selected' : '' }}>Suspension</option>
                                                <option value="Powder" {{ old('packaging', $getRecord->packaging) == 'Powder' ? 'selected' : '' }}>Powder</option>
                                                <option value="Inhaler" {{ old('packaging', $getRecord->packaging) == 'Inhaler' ? 'selected' : '' }}>Inhaler</option>
                                                <option value="Other" {{ old('packaging', $getRecord->packaging) == 'Other' ? 'selected' : '' }}>Other</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="supplier_id" id="supplier_id" class="form-select @error('supplier_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($getSuppliers as $supplier)
                                                    <option value="{{ $supplier->id }}" {{ old('supplier_id', $getRecord->supplier_id) == $supplier->id ? 'selected' : '' }}>{{ $supplier->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="prescription_required" id="prescription_required" class="form-select" required>
                                                <option value="0" {{ old('prescription_required', $getRecord->prescription_required) == '0' ? 'selected' : '' }}>No (OTC Product)</option>
                                                <option value="1" {{ old('prescription_required', $getRecord->prescription_required) == '1' ? 'selected' : '' }}>Yes (Rx Only)</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="temperature_control" id="temperature_control" class="form-select">
                                                <option value="Room Temp" {{ old('temperature_control', $getRecord->temperature_control) == 'Room Temp' ? 'selected' : '' }}>Standard Room Temp (15-25°C)</option>
                                                <option value="Refrigerated" {{ old('temperature_control', $getRecord->temperature_control) == 'Refrigerated' ? 'selected' : '' }}>Refrigerated (2-8°C)</option>
                                                <option value="Frozen" {{ old('temperature_control', $getRecord->temperature_control) == 'Frozen' ? 'selected' : '' }}>Frozen (Below -15°C)</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row mt-2">
                                                @if(!empty($getRecord->getProfileImage()))
                                                    <div class="col-md-3 col-sm-6 mb-2">
                                                        <span class="d-block text-secondary small mb-2 fw-medium">Current Label:</span>
                                                        <img src="{{ $getRecord->getProfileImage() }}" alt="Current Label" 
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-2 d-none" id="previewContainer">
                                                    <span class="d-block text-secondary small mb-2 fw-medium">New Label Preview:</span>
