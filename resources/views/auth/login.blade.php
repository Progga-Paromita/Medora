    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body p-4">
          ...
          <p class="login-box-msg mb-4 text-secondary">Sign in to start your secure session</p>
            ...
            <div class="row align-items-center mb-3">
              <div class="col-7">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="remember" id="remember" style="background-color: rgba(17, 24, 39, 0.6); border-color: rgba(255, 255, 255, 0.15);" />
                  <label class="form-check-label text-secondary text-sm" for="remember"> Remember Me </label>
                </div>
              </div>
          ...
          <div class="mt-4 pt-3 border-top text-center" style="border-color: rgba(255, 255, 255, 0.08) !important;">
            <a href="{{ url('forgot-password') }}" class="text-decoration-none text-primary text-sm" style="color: #FACA5A !important;">
